 ...
 *  Input:  66-byte stage-1 source buffer
 *  Output: 16-byte raw AES key for the Phase 5 block encryptor
 *
 *  The caller is responsible for supplying the correct 66-byte input.
 *  This file only implements the schedule itself; it does not guess or
